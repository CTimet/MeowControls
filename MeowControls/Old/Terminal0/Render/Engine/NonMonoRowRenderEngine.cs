...
{
    private FormattedTextCache _cache = new(typeface, fontSize, defaultForeground);
...
{
    private readonly IBrush _defaultForeground;
    ...
    public FormattedTextCache(Typeface typeface, double defaultFontSize, IBrush defaultForeground)
    {
        ...
        Empty = new FormattedText(" ", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);

        A = new FormattedText("A", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        B = new FormattedText("B", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        C = new FormattedText("C", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        D = new FormattedText("D", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        E = new FormattedText("E", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        F = new FormattedText("F", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        G = new FormattedText("G", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        H = new FormattedText("H", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        I = new FormattedText("I", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        J = new FormattedText("J", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        K = new FormattedText("K", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        L = new FormattedText("L", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        M = new FormattedText("M", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        N = new FormattedText("N", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        O = new FormattedText("O", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        P = new FormattedText("P", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Q = new FormattedText("Q", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        R = new FormattedText("R", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        S = new FormattedText("S", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        T = new FormattedText("T", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        U = new FormattedText("U", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        V = new FormattedText("V", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        W = new FormattedText("W", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        X = new FormattedText("X", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Y = new FormattedText("Y", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Z = new FormattedText("Z", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        ...
        Num0 = new FormattedText("0", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Num1 = new FormattedText("1", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Num2 = new FormattedText("2", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Num3 = new FormattedText("3", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Num4 = new FormattedText("4", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Num5 = new FormattedText("5", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Num6 = new FormattedText("6", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Num7 = new FormattedText("7", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Num8 = new FormattedText("8", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
        Num9 = new FormattedText("9", CultureInfo.CurrentCulture, FlowDirection.LeftToRight, Typeface, FontSize,
            defaultForeground);
