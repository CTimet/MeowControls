...
public class Renderer
{
    ...
    public void Initialize(Rect bounds)
    {
        ...
        if (_rowRenderEngine is null)
        {
            SwitchRowRenderEngine();
        }
    }
    ...
    public void SwitchRowRenderEngine()
    {
        _rowRenderEngine = Typeface.FontFamily.IsMonospaceFont()
            ? new MonoRowRenderEngine(Typeface, FontSize, NormalForeground, SelectedBackground, SelectedForeground, _renderCellWidth, _renderCellHeight)
            : new NonMonoRowRenderEngine(Typeface, FontSize, NormalForeground, SelectedBackground, SelectedForeground, _renderCellWidth, _renderCellHeight);
    }
