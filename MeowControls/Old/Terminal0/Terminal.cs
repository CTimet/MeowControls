...
public class Terminal : Control
{
    ...
    public static readonly StyledProperty<int> MaxSaveRenderRowsProperty = AvaloniaProperty.Register<Terminal, int>(
        nameof(MaxSaveRenderRows), defaultValue: 9999);
    
    public static readonly StyledProperty<FontFamily> FontFamilyProperty = AvaloniaProperty.Register<Terminal, FontFamily>(
    ...
    public static readonly StyledProperty<FontWeight> FontWeightProperty = AvaloniaProperty.Register<Terminal, FontWeight>(
        nameof(FontWeight), defaultValue: FontWeight.Normal);

    public static readonly StyledProperty<FontStretch> FontStretchProperty = AvaloniaProperty.Register<Terminal, FontStretch>(
        nameof(FontStretch), defaultValue: FontStretch.Normal);

    public static readonly StyledProperty<double> FontSizeProperty = AvaloniaProperty.Register<Terminal, double>(
        nameof(FontSize), defaultValue: 12.0);

    public static readonly StyledProperty<IImmutableSolidColorBrush> NormalForegroundProperty = AvaloniaProperty.Register<Terminal, IImmutableSolidColorBrush>(
        nameof(NormalForeground), defaultValue: Brushes.Black);

    public static readonly StyledProperty<IImmutableSolidColorBrush> SelectedForegroundProperty = AvaloniaProperty.Register<Terminal, IImmutableSolidColorBrush>(
        nameof(SelectedForeground), defaultValue: Brushes.Black);

    public static readonly StyledProperty<IImmutableSolidColorBrush> SelectedBackgroundProperty = AvaloniaProperty.Register<Terminal, IImmutableSolidColorBrush>(
        nameof(SelectedBackground), defaultValue: Brushes.LightSkyBlue);

    public static readonly StyledProperty<IImage?> BackgroundImageProperty = AvaloniaProperty.Register<Terminal, IImage?>(
        nameof(BackgroundImage), defaultValue: null);

    public static readonly StyledProperty<double> LeftSpaceRemainProperty = AvaloniaProperty.Register<Terminal, double>(
        nameof(LeftSpaceRemain), defaultValue: 5.0);

    public static readonly StyledProperty<double> TopSpaceRemainProperty = AvaloniaProperty.Register<Terminal, double>(
        nameof(TopSpaceRemain), defaultValue: 5.0);
    ...
    public double FontSize
    {
        ...
        set
        {
            if (GetValue(FontSizeProperty).Equals(value))
            {
                return;
            }
    ...
    public FontStretch FontStretch
    {
        ...
        set
        {
            if (GetValue(FontStretchProperty).Equals(value))
            {
                return;
            }
    ...
    public FontWeight FontWeight
    {
        ...
        set
        {
            if (GetValue(FontWeightProperty).Equals(value))
            {
                return;
            }
    ...
    public FontStyle FontStyle
    {
        ...
        set
        {
            if (GetValue(FontStyleProperty).Equals(value))
            {
                return;
            }
    ...
    public FontFamily FontFamily
    {
        ...
        set
        {
            if (GetValue(FontFamilyProperty).Equals(value))
            {
                return;
            }
